...
public class JustifiedTextView extends View {
     ...
     * @param textPaint		text with Paint type
     * @param textAreaWidth	width of text area
     * @return	String which has been justified.
     */
     ...
     * @param lineListSize	the size of line list
     * @param lineHeigth	the height of line list
     * @param lineSpace		the space of line list
     */
     ...
     * -noghteh:text
     * @param text	text to be shown in TextView
     */
    ...
    /***
     * set text color
     * @param textColor	color Int for TextView
     */
     ...
     * @param lineSpace	number of line
     */
    ...
    /***
     * get text alignment
     * @return	alignment of the TextView
     */
     ...
     * @param align align of the TextView
     */
